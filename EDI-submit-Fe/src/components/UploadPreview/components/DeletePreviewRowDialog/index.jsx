  ...
  const handleDelete = async () => {
    try {
      ...
      const response = await AxiosInstance.delete(
        `/api/temp-experience/${previewClickedRowData?.id}`
      );
        ...
        <Grid>
          ...
          <Box sx={style}>
            ...
            <Typography id="modal-modal-description" sx={{ mt: 2 }}>
              Are you sure you want to delete this Data Record? <br />
              Customer Ref No :
              <strong>{previewClickedRowData?.customerRefNo}</strong>
              <br />
              Account Name :
              <strong>{previewClickedRowData?.accountName1}</strong>
              <br />
            </Typography>
...
export default DeletePreviewRowDialog;
